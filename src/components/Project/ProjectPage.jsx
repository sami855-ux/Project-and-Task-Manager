...
const ProjectsPage = () => {
  ...
  const handleAddProject = async () => {
    ...
    try {
      ...
      if (res.success) {
        // Optionally, fetch the newly created project from the response
        const createdProject = res.data[0];
        const project = {
          id: createProject.id, // Use the actual ID from the database
          ...createdProject,
          tasksDone: 0,
          tasksTotal: 0,
        ...
        console.log("Failed to create project:", res.error);
      }
    } catch (error) {
  ...
  const ProjectCard = ({ project }) => {
    ...
    return (
      <Card
        className={`hover:shadow-lg transition-shadow border-gray-200 duration-200 pt-0 ${
          project.pinned ? "border-2 border-blue-200" : ""
        }`}
      >
                ...
                <span
                  className={
                    isOverdue(project.deadline)
                      ? "text-red-400 font-bold font-geist"
                      : "text-green-300 font-geist"
                  }
                >
        ...
        <CardHeader className="pb-3">
          <div className="flex justify-between items-start">
            <div>
              ...
              <CardDescription className="mt-1 font-jakarta">
                {project.description}
              </CardDescription>
            </div>
            <Badge className={`${colorClasses[project.color]} font-jakarta`}>
              {project.tags[0]}
            </Badge>
          </div>
        </CardHeader>
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center text-sm">
              ...
              <span className="font-mozilla">
                {project.tasksTotal} Tasks ({project.tasksDone} Done,{" "}
                {project.tasksTotal - project.tasksDone} Pending)
              </span>
            </div>
          </div>
        </CardContent>
          ...
          <Tooltip>
            <TooltipTrigger>
              <Button
                ...
                className={"border-gray-200 font-geist"}
              >
  ...
  const ProjectListItem = ({ project }) => (
    <Card
      className="mb-4 hover:shadow-md transition-shadow duration-200 border-l-4 border-gray-200 rounded-none"
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-2">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  {project.status === "completed" && (
                    <Badge
                      variant="secondary"
                      className="text-xs bg-green-100 text-green-800 font-jakarta"
                    >
                      Completed
                    </Badge>
                  )}
              ...
              <div className="lg:hidden mt-3 space-y-2">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="text-gray-700 font-mozilla">
                    {project.progress}%
                  </span>
                </div>
          ...
          <div className="hidden lg:flex items-center gap-6 flex-shrink-0">
            <div className="w-32">
              <div className="flex justify-between text-sm mb-1">
                ...
                <span className="font-medium text-gray-900 font-mozilla">
                  {project.progress}%
                </span>
              </div>
              <Progress value={project.progress} className="h-2" />
          ...
          <div className="flex items-center justify-between lg:justify-end gap-2 flex-shrink-0">
            ...
            <div className="lg:hidden flex items-center gap-2">
              {getStatusIcon(project)}
              {isOverdue(project.deadline) && (
                <span className="text-xs text-red-600 font-medium font-geist">
                  Overdue
                </span>
              )}
            </div>
  ...
  return (
    <div className="container mx-auto p-6 max-w-7xl border border-gray-200">
      {/* Header Section */}
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8 gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 font-geist">
            My Projects
          </h1>
          <p className="text-gray-600 mt-1 font-jakarta">
        ...
        <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
          ...
          <DialogContent>
            ...
            <div className="space-y-4 py-4 font-geist">
              ...
              <div>
                <Label htmlFor="deadline" className={"pb-2"}>
                  Deadline
                </Label>
                <Input
                  id="deadline"
              ...
              <div>
                ...
                <Select
                  ...
                  className={"w-80 border-gary-200"}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
            ...
            <DialogFooter>
              <Button
                ...
                className={"font-mozilla border-gray-300"}
              >
                Cancel
              </Button>
              <Button
        ...
        <div className="flex gap-2 flex-wrap font-jakarta">
          <Select value={sortBy} onValueChange={setSortBy}>
            ...
            <SelectContent className={"border-gray-200"}>
              <SelectItem value="deadline" className={"font-jakarta"}>
                Deadline
              </SelectItem>
              <SelectItem value="progress" className={"font-jakarta"}>
                Progress
              </SelectItem>
              <SelectItem value="created" className={"font-jakarta"}>
                Creation Date
              </SelectItem>
              <SelectItem value="alphabetical" className={"font-jakarta"}>
                Alphabetical
              </SelectItem>
              <SelectItem value="pinned" className={"font-jakarta"}>
                Pinned First
              </SelectItem>
            </SelectContent>
          </Select>
          ...
          <Select value={statusFilter} onValueChange={setStatusFilter}>
            ...
            <SelectContent className={"border-gray-200"}>
              <SelectItem value="all" className={"font-jakarta"}>
                All Projects
              </SelectItem>
              <SelectItem value="active" className={"font-jakarta"}>
                Active
              </SelectItem>
              <SelectItem value="completed" className={"font-jakarta"}>
                Completed
              </SelectItem>
              <SelectItem value="overdue" className={"font-jakarta"}>
                Overdue
              </SelectItem>
              <SelectItem value="pinned" className={"font-jakarta"}>
                Pinned
            ...
            <div className="space-y-4 py-4">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setEditingProject({ ...editingProject, color: value })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
