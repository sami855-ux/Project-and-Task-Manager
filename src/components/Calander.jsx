...
const CalendarPage = () => {
      ...
      tasks: [
        {
          ...
          description:
            "Complete the user authentication module with OAuth integration",
          assignee: "You",
        ...
        },
        {
          ...
          description:
            "Create responsive design templates for mobile and desktop",
          assignee: "You",
  ...
  const filteredTasks = useMemo(() => {
    return tasks.filter((task) => {
      ...
      return (
        matchesProject && matchesPriority && matchesStatus && matchesSearch
      );
    });
